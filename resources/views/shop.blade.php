                    ...
                    <div  class="ui cards">
                        <div class="card product">
                            <div class="image attachment">
                                <img class="product-image" src="{{ asset('images/demo/cloth-532x555.jpg') }}">
                                ...
                                <div class="mini-attachments">
                                    <img src="{{ asset('images/demo/dishcloth-532x555.jpg') }}" class="ui mini image">
                                    <img src="{{ asset('images/demo/cloth-532x555.jpg') }}" class="ui mini image">
                                </div>
                            </div>
                            <div class="content">
